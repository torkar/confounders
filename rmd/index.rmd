...
```
```{r func-sim, cache=TRUE, include=FALSE}
...
<!-- HPDI(res[[1]][1:200, 1], prob = 0.95) # s=1/96, and all rows from column n=1/19 -->
<!-- Plotta en metaanalysis för alla plottar -->
