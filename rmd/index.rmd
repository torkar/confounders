...
The simulation indicates (even when we add noise) that we can recover the parameters we set. Let's create a data set where we also have a confounder $C$, which we condition on.

```{r 2nd-sim, cache=TRUE, warning=FALSE, message=FALSE}
N <- 250 # Sample size
